...
<body>
  ...
  <div class="container margin-top-10">
    <s:form id="book-form" action="update_book_post" method="post">
      <div class="form-group">
        <label for="title">Title:</label>
        <s:textfield name="title" required="required" class="form-control"/>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <s:textfield name="isbn" readonly="true" class="form-control"/>
      </div>
      <div class="form-group">
        <label for="publisher">Publisher:</label>
        <s:textfield name="publisher" required="required" class="form-control"/>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <s:textfield type="number" name="price" step="0.01" placeholder="0.00" required="required" class="form-control"/>
      </div>
